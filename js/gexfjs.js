		...
		$.ajax({
			url: location_url, 	
				...
				for (var g in _genome_menu){
					...
					result.push('<span id="'+g+'_header">'+_genome_menu[g].genome_name+' (<span id="'+g+'_num" ><a href="#" onclick="displayPath(undefined,'+"'"+_genome_menu[g].sids.join(',')+"'"+'); return false;">'+num_sid+'</a></span>)</span>\n<div>\n');
